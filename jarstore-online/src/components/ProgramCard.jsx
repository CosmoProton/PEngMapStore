...
export function ProgramCard({ program, onDownload, onDelete, onUpdate }) {
  ...
  const [previewVisible, setPreviewVisible] = useState(Boolean(program.preview_url && program.is_previewable));
  ...
  const contribsLower = (program.contributors || '')
    .split(',')
        ...
        {editing ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <button className="btn btn-ghost btn-sm" style={{ padding: '4px' }} onClick={() => setEditing(false)}>
                <X size={16} />
              </button>
            </div>
            ...
            <textarea
              className="textarea"
              style={{ fontSize: 13, minHeight: 120, fontFamily: 'var(--font-mono)' }}
              value={editDesc}
            ...
            <input
              ...
              style={{ fontSize: 13 }}
              value={editContribs}
              onChange={e => setEditContribs(e.target.value)}
          ...
          <>
            <div style={S.header}>
              <div style={S.iconBox}>
                <ImageIcon size={24} color="var(--text-primary)" />
              </div>
            ...
            {previewVisible && program.preview_url && (
              <div style={S.previewWrap}>
                <img
                  src={program.preview_url}
                  alt={program.name}
            ...
            {program.uploader && (
              <div style={S.uploaderRow}>
                <img
                  src={program.uploader_avatar || 'https://github.com/ghost.png'}
                  style={S.uploaderAvatar}
                  alt=""
                />
      ...
      {showInfo && (
        <div className="modal-overlay" onClick={() => setShowInfo(false)}>
          ...
          >
            ...
            <div
              style={{ flex: 1, overflowY: 'auto', paddingRight: 8, marginBottom: 20 }}
              className="full-markdown-container"
            >
              {previewVisible && program.preview_url && (
              ...
              >
                {program.original_name || 'No file name available'}
              </code>
            </div>
            ...
            >
              <div style={{ flex: 1, minWidth: 200 }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                  {program.uploader && <span className="badge badge-gray">@{program.uploader} (Uploader)</span>}
